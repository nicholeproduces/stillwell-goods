...
export function Hero() {
  return (
    ...
    >
      <div className="pointer-events-none absolute -right-24 top-8 h-[min(72vw,520px)] w-[min(72vw,520px)] rounded-full bg-sw-green/12 blur-3xl max-lg:top-4 max-lg:h-[min(56vw,380px)] max-lg:w-[min(56vw,380px)]" />
      ...
      <div className="relative mx-auto grid max-w-7xl gap-5 px-5 pb-14 pt-2 sm:gap-10 sm:px-8 sm:pb-20 sm:pt-12 lg:grid-cols-12 lg:gap-6 lg:px-10 lg:pb-24 lg:pt-14">
        <div className="order-2 flex flex-col justify-start gap-5 sm:gap-8 lg:order-1 lg:col-span-6 lg:row-span-2 lg:justify-end lg:gap-8">
          <div className="hero-logo-wrap group relative max-w-xl leading-none">
