...
export function FamilySection() {
  return (
    <section
      id="family"
      className="border-b border-sw-ink/10 bg-sw-paper py-20 sm:py-28"
    >
      <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10">
        <div className="grid items-center gap-12 lg:grid-cols-12 lg:gap-8">
          <Reveal className="order-2 lg:order-1 lg:col-span-5">
            <p className="text-[10px] font-semibold uppercase tracking-[0.35em] text-sw-brown">
              The Family
            </p>
            <h2 className="mt-4 text-3xl font-semibold leading-tight tracking-tight text-sw-ink sm:text-4xl">
              Meet The Family
            </h2>
          ...
          <Reveal className="order-1 lg:order-2 lg:col-span-7">
            <div className="relative mx-auto max-w-lg lg:mx-0 lg:max-w-none">
              ...
              <div className="relative aspect-[3/4] w-full translate-x-0 overflow-hidden rounded-sm bg-sw-ink/5 shadow-[0_30px_80px_-40px_rgba(20,20,20,0.55)] lg:-translate-x-6 lg:translate-y-4">
                <FallbackImage
